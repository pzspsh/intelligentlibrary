...
func main() {
	fmt.Println(longestCommonPrefix5([]string{"flower", "flow", "flight"}))
	fmt.Println(longestCommonPrefix5([]string{"a"}))
	fmt.Println(longestCommonPrefix5([]string{"abc", "acb", "bac"}))
}
